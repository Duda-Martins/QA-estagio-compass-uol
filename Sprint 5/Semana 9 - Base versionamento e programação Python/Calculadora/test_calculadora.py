...
def test_soma(n1_soma, n2_soma, resultado_esperado_soma)
    assert soma(n1_soma, n2_soma) == resultado_esperado_soma
...
def test_subtracao(n1_subtracao, n2_subtracao, resultado_esperado_subtracao)
    assert subtracao(n1_subtracao, n2_subtracao) == resultado_esperado_subtracao
...
def test_multiplicacao(n1_multiplicacao, n2_multiplicacao, resultado_esperado_multiplicacao)
    assert multiplicacao(n1_multiplicacao, n2_multiplicacao) == resultado_esperado_multiplicacao
...
def test_divisao(n1_divisao, n2_divisao, resultado_esperado_divisao)
    assert divisao(n1_divisao, n2_divisao) == resultado_esperado_divisao

@pytest.mark.parametrize("n1_elevado_quadrado, n2_elevado_quadrado, resultado_esperado_elevado_quadrado", [(2, 2, 4), (10, 2, 100), (4, 2, 16)])
def test_elevado_quadrado(n1_elevado_quadrado, n2_elevado_quadrado, resultado_esperado_elevado_quadrado)
    assert elevado_quadrado(n1_elevado_quadrado, n2_elevado_quadrado) == resultado_esperado_elevado_quadrado
...
def test_media(n1_media, n2_media, resultado_esperado_media)
    assert media(n1_media, n2_media) == resultado_esperado_media